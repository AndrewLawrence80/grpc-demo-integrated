...
// Source: api/greeter/greeter_grpc.pb.go
...
import (
	...
	greeter "github.com/andrewlawrence80/grpc-demo-integrated/api/greeter"
...
func (m *MockGreeterClient) SayHello(ctx context.Context, in *greeter.HelloRequest, opts ...grpc.CallOption) (*greeter.HelloResponse, error) {
	m.ctrl.T.Helper()
...
// SayHello mocks base method.
func (m *MockGreeterServer) SayHello(arg0 context.Context, arg1 *greeter.HelloRequest) (*greeter.HelloResponse, error) {
	m.ctrl.T.Helper()
